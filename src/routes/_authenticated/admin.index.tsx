        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-xl border border-border bg-background p-4">
            ...
            <div className="mt-2 flex items-center gap-2 rounded-lg border border-border px-3 py-2">
              ...
              <button onClick={() => copy(contactUrl)} className="rounded-lg p-2 text-muted-foreground transition-all duration-200 ease-out hover:bg-secondary hover:text-foreground active:scale-[0.92]" aria-label="Copy contact webhook URL">
